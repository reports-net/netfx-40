...
Namespace Sample
    ...
    Class Window1
        ...
        Private Sub Button_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            If radPrint.IsChecked = True Or radPreview_WPF.IsChecked = True Or radXPS.IsChecked = True Then ' 印刷、又は、WPFプレビュー、XPS出力 が選択されている場合
            ...
            If radPreview_WPF.IsChecked = True Then  'WPF版プレビューが選択されている場合

                paoRep.WpfPreview(documentViewer) ' 印刷又はプレビューを実行

            ElseIf radPreview.IsChecked = True _
            Or radPrint.IsChecked = True Then '印刷・プレビューが選択されている場合
